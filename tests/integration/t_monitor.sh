...
run_can run --monitor --recipe "$CONFIG" -- echo "monitored"
...
run_can run --monitor --recipe "$CONFIG" -- echo "test"
...
run_can run --monitor --recipe "$CONFIG" -- true
...
run_can run --monitor --strict --recipe "$CONFIG" -- true
